...
const SwitchBG = () => {
  // Set default theme to retro or retrieve it from localStorage
  ...
  // Set the theme in the `data-theme` attribute
  useEffect(() => {
    ...
    <div className=" flex items-center justify-center">
      <div className="text-center">
        ...
        <label className="swap swap-rotate">
          {/* This checkbox controls the swap */}
          <input
            type="checkbox"
